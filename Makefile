...
SOURCES = \
	__init__.py \
	ermes_qgis.py ermes_qgis_dialog.py

PLUGINNAME = ermes_qgis

PY_FILES = \
	__init__.py \
	ermes_qgis.py ermes_qgis_dialog.py

UI_FILES = ermes_qgis_dialog_base.ui
...
QGISDIR=C:\Users\GaetanoChiriaco\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
